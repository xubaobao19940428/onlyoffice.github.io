...
;(function (window, undefined) {
	...
	window.Asc.plugin.attachContextMenuClickEvent = function (id, action) {
		...
		if (!pluginObj.contextMenuEvents) pluginObj.contextMenuEvents = {}
	...
	window.Asc.plugin.event_onContextMenuClick = function (id) {
		...
		if (pluginObj.contextMenuEvents && pluginObj.contextMenuEvents[itemId]) pluginObj.contextMenuEvents[itemId].call(pluginObj, itemData)
	}
	...
	window.Asc.plugin.detachEvent = function (id) {
		var pluginObj = window.Asc.plugin
		if (pluginObj._events && pluginObj._events[id]) delete pluginObj._events[id]
	}
	window.Asc.plugin.onEvent = function (id, data) {
		var pluginObj = window.Asc.plugin
		if (pluginObj._events && pluginObj._events[id]) pluginObj._events[id].call(pluginObj, data)
	}

	window.onunload = function () {
		if (window.addEventListener) window.removeEventListener('message', onMessage, false)
